...
void __kernel math_functions(__global double *matrix_in, __global double *matrix_out){
    ...
    matrix_out[2*gsz_0 + gid_0] = matrix_in[gsz_0*2 + gid_0] * (double)(1.1);
    matrix_out[3*gsz_0 + gid_0] = matrix_in[gsz_0*3 + gid_0] / (double)(1.1);
    ...
    matrix_out[28*gsz_0 + gid_0] = fdim(matrix_in[gsz_0*28 + gid_0], (double)(2.0));
    matrix_out[29*gsz_0 + gid_0] = fma((double)(2.0),(double)(1.1),matrix_in[gsz_0*29 + gid_0]);
